...
import { groups, getBandwidth, getTicks, toStacked, getMapData, getMaxGroup } from '../common/util'
...
@Component({
    selector: 'StackedLineChart',
    templateUrl: './stackedlinechart.component.html',
    styleUrls: ['./stackedlinechart.component.less'],
})
export class StackedLineChartComponent implements OnChanges {
    ...
    ngOnChanges(changes: SimpleChanges): void {
        ...
        this.groupData = groups(toStacked(this.mapData), 'group', null)
